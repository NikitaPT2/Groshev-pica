...
public class Groshev_pica_2PT{
	...
	public static void pizza_izv(double price) {
		...
		String uzvards,adresi, talruni;
		uzvards = JOptionPane.showInputDialog("Ievadiet savu uzvardu: ");
		adresi = JOptionPane.showInputDialog("Ievadiet savu adresi: ");
		talruni = JOptionPane.showInputDialog("Ievadiet savu tālruni: ");
        JOptionPane.showMessageDialog(null, "Informacija par piegade: \n Uzvards: "+uzvards+
        		"\n Adrese: "+adresi+"\n Talrunis: "+talruni);
        }
	
		public static void uzvietas(){
		String uzvards, talruni;
		uzvards = JOptionPane.showInputDialog("Ievadiet savu uzvardu: ");
		talruni = JOptionPane.showInputDialog("Ievadiet savu tālruni: ");
